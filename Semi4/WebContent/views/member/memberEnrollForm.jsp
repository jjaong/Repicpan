   ...
   <div class="outer">
      ...
      <br>
         ...
         <table>
            <tr>
               <td>&nbsp;&nbsp;아이디</td>
               <td colspan="2"><input type="text" required maxlength="20" name="userId" id="iuserId" class="member_enroll" style="width : 235px;">
               		<p class="idSuccessCheck" style="font-size : 12px; margin-left : 6px; margin-top : -5px; margin-bottom : -5px;">영문 대소문자와 숫자 사용,4~12자리로 입력 :)</p> 
               		<input type="hidden" id="idDoubleChk"/>
               </td>
            </tr>
            <tr>
               <td>&nbsp;&nbsp;비밀번호</td>
               <td><input type="password" name="userPwd" maxlength="50" required class="member_enroll" style="width : 235px;"></td>
               <td></td>
            </tr>
            <tr>
               <td>&nbsp;&nbsp;비밀번호확인</td>
               <td><input type="password" name = "checkuserPwd" maxlength="50" required class="member_enroll" style="width : 235px;"></td>
               <td></td>
            </tr>
            <tr>
               <td>&nbsp;&nbsp;이름</td>
               <td><input type="text" name="userName" maxlength="50" required class="member_enroll" style="width : 235px;"> </td>
               <td></td>
            </tr>
            <tr>
               <td>&nbsp;&nbsp;이메일</td>
               <td><input type="email" name="email" maxlength="50" required class="member_enroll" style="width : 235px;"></td>
               <td><button type="button" onclick="emailCheck()" class="check_btn" id="emailchkbtn" >중복확인</button></td>
            </tr>
            <tr>
               <td>&nbsp;&nbsp;주소</td>
               <td><input type="text" name="address" class="member_enroll" style="width : 235px;"></td>
               <td></td>
            </tr>
            <tr>
               <td>&nbsp;&nbsp;전화번호</td>
               <td><input type="text" name="phone"  class="member_enroll" style="width : 235px;"></td>
               <td></td>
            </tr>
            <tr>
               <td>&nbsp;&nbsp;닉네임</td>
               <td><input type="text" name="nickName" class="member_enroll" style="width : 235px;"></td>
   ...
   <script>
      ...
      $("#iuserId").blur(function(){
          ...
          if(userId == "" || userId.length < 4){
      		$(".idSuccessCheck").text("4~12자리로 입력해주세요.");
  			$(".idSuccessCheck").css("color", "red");
          
          }else {$.ajax({
             type : "POST",
             url : "idCheck.me",
             data : {checkId :$("#iuserId").val()},
             success : function(result){

             	
             	if(result == "NNNNN"){ 
             	  
             	   $(".idSuccessCheck").text("이미 사용하는 아이디입니다.")
                    $(".idSuccessCheck").css("color","red")
             	}               
                else{    
             	   $(".idSuccessCheck").text("사용가능한 아이디입니다.")
                    $(".idSuccessCheck").css("color","green")
